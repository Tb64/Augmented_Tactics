...
{
    public class AttackerCombatNode : PropertyNode
    {
        [JsonIgnore]
        ...
        [JsonIgnore]
        public override string Name { get { return "Attacker"; } }

        public override string Description
        {
            get { return "Represents the attacking combat character"; }
        }
        ...
        {
            var variable = nodeChain.CombatantA;
            if (variable != null)
            {
