...
namespace LogicSpawn.RPGMaker.Core
{
    ...
    public class GetCustomVarBool : PropertyNode
    {
        public override string Name
        {
            get { return "Get Custom Variable Bool"; }
        }

        public override string Description
        {
            get { return "Gets the custom variable's bool value"; }
        }
        ...
        public override object EvaluateInput(NodeChain nodeChain, Func<object,object> func)
        {
            ...
            if (func != null)
            {
                var result = (bool)func(customVariable.BoolValue);
                customVariable.BoolValue = result;
            }

            return customVariable.BoolValue;
        }
    }
}