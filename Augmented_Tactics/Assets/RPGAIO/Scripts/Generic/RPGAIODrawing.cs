...
public static class RPGAIODrawing
{
...
//        }
    ...
    public static void BezierLineX(Vector2 start, Vector2 startTangent, Vector2 end, Vector2 endTangent, Color color, float width, bool antiAlias, int segments, float maxX, float maxY)
    {
