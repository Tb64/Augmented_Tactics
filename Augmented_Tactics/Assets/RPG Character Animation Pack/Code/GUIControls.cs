...
public class GUIControls : MonoBehaviour{
	...
	void OnGUI(){
		...
		if(!rpgCharacterController.isDead){
			if(rpgCharacterController.weapon == WeaponID.RELAX || rpgCharacterController.weapon != WeaponID.UNARMED){
				if(GUI.Button(new Rect(1115, 310, 100, 30), "Unarmed")){
					...
					rpgCharacterController.weapon = WeaponID.UNARMED;
					rpgCharacterController.canAction = true;
					rpgCharacterController.animator.SetTrigger("RelaxTrigger");
				}
				if(!rpgCharacterController.isSitting && !rpgCharacterController.isMoving && rpgCharacterController.weapon == WeaponID.RELAX){
			...
			if(rpgCharacterController.canAction && !rpgCharacterController.isRelax){
				if(rpgCharacterController.isGrounded){
					...
					if(rpgCharacterController.weapon != WeaponID.TWOHANDCROSSBOW && rpgCharacterController.weapon != WeaponID.RIFLE){
					...
					if(blockGui){
						...
						//ATTACK LEFT
						if(rpgCharacterController.weapon == WeaponID.SHIELD || rpgCharacterController.weapon == WeaponID.RIFLE || rpgCharacterController.weapon != WeaponID.ARMED || (rpgCharacterController.weapon == WeaponID.ARMED && rpgCharacterController.leftWeapon != 0) && rpgCharacterController.leftWeapon != 7){
							if(GUI.Button(new Rect(25, 85, 100, 30), "Attack L")){
								rpgCharacterController.Attack(1);
							}
						}
						//ATTACK RIGHT
						if(rpgCharacterController.weapon == WeaponID.RIFLE || rpgCharacterController.weapon != WeaponID.ARMED || (rpgCharacterController.weapon == WeaponID.ARMED && rpgCharacterController.rightWeapon != 0) || rpgCharacterController.weapon == WeaponID.ARMEDSHIELD){
							if(rpgCharacterController.weapon != WeaponID.SHIELD){
						...
						if(!rpgCharacterController.isMoving){
							if(rpgCharacterController.weapon == WeaponID.UNARMED){
				...
				if(!blockGui && !rpgCharacterController.isBlocking && rpgCharacterController.isGrounded){
					...
					if(rpgCharacterController.weapon != WeaponID.ARMED){
					...
					else if(rpgCharacterController.weapon == WeaponID.ARMED){
				...
				if((rpgCharacterController.weapon == WeaponID.ARMED || rpgCharacterController.weapon == WeaponID.STAFF || rpgCharacterController.weapon == WeaponID.UNARMED) && !blockGui && rpgCharacterController.isGrounded){
